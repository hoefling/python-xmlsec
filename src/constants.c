...
#endif
#if XMLSEC_VERSION_HEX > 306 && !defined(XMLSEC_CRYPTO_NSS)
...
#endif
#if !defined(XMLSEC_NO_RIPEMD160) && !defined(XMLSEC_CRYPTO_NSS)
...
#if XMLSEC_VERSION_HEX > 315 && !defined(XMLSEC_CRYPTO_NSS)
